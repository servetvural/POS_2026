...
namespace BSLayer
{
    ...
    public class trmOrderPadMain : System.Windows.Forms.Form
    {
        ...
        private async Task LoadViewBars()
        {
            ...
            {
                ToolStripMenuItem btn = new ToolStripMenuItem();
                btn.Image = global::BSLayer.Properties.Resources.chef64;
                btn.Tag = distro;
        ...
        private async Task LoadBonusSchemes()
        {
            ...
            {
                ToolStripMenuItem btn = new ToolStripMenuItem();
                btn.Image = global::BSLayer.Properties.Resources.Bonus48;
        ...
        private void btnSupplierPurchaseList_Click(object sender, EventArgs e)
        {
            ...
            //            item.Image = global::BSLayer.Properties.Resources.trolly48;
            //        else
            //            item.Image = null; // global::BSLayer.Properties.Resources.happy2_48;
            //    }
        ...
        private async Task LoadSupplierList()
        {
            ...
            foreach (var supp in suppliers)
            {
                ...
                btn.Tag = supp.IID;
                //btn.Image = global::BSLayer.Properties.Resources.trolly48;
