...
public class PosConfig
{
    ...
    [CategoryAttribute("16.Other Order Settings"), DisplayName("Background Colour of Cancel Button"), DescriptionAttribute("Background Colour of Cancel Button"), DefaultValueAttribute("Black")]
    ...
    public FormWindowStateTypes Lock_Screen_Window_Format { get; set; } = FormWindowStateTypes.Normal;
    ...
    [CategoryAttribute("19.Screen Lock / Screen Saver Settings"), DisplayName("Image Folder"), DescriptionAttribute("Image Folder to pickup screen saver images")]
    ...
    [CategoryAttribute("23.Report Settings"), DisplayName("Name of report logo/image file"), DescriptionAttribute("Report Image Filename with extension")]
