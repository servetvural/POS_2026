...
public partial class PosDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Configure Many-to-Many: Distribution <-> Printer
        modelBuilder.Entity<Distribution>()
            .HasMany(d => d.printers)
            .WithMany(p => p.distributions)
            .UsingEntity(j => j.ToTable("DistributionPrinters"));
        ...
        // 1. Get all entity types that inherit from BaseClass
        ...
        //    // 2. Ensure Id is Identity (Database Generated)
        //    entity.Property("Id")
        //        .ValueGeneratedOnAdd();

        //    // 3. Create a Unique Index on the software-provided IID
        //    entity.HasIndex("IID")
        //        .IsUnique();

        //    // 4. (Optional) Set IID as Required
        //    entity.Property("IID")
        //        .IsRequired()
        //        .HasMaxLength(450); // Good for index performance in SQL Server
        //}
