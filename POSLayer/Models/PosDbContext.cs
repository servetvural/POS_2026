    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DistributionView>(entity =>
        {
            ...
            entity.Property(e => e.PrinterIID)
                ...
                .IsUnicode(false)
                .HasColumnName("PrinterIID");
            entity.Property(e => e.PrinterNetworkName)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.ShortName)
                .HasMaxLength(5)
        ...
        modelBuilder.Entity<EntityButtonStockItemRecipe>(entity =>
        {
            entity
                .HasNoKey()
        ...
        modelBuilder.Entity<PrinterView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("PrinterView");
        ...
        modelBuilder.Entity<ServiceChargeSummary>(entity =>
        {
            entity
                .HasNoKey()
        ...
        modelBuilder.Entity<SessionSum>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("SessionSum");
        ...
        modelBuilder.Entity<TaxPercentList>(entity =>
        {
            entity
                .HasNoKey()
        ...
        modelBuilder.Entity<TaxSummaryTotalView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("TaxSummaryTotalView");
        });

        modelBuilder.Entity<UncompletedOrdersSessionSum>(entity =>
        {
            entity
                .HasNoKey()
        ...
        modelBuilder.Entity<UncompletedOrdersView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("UncompletedOrdersView");
        ...
        modelBuilder.Entity<XordersView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("XOrdersView");
