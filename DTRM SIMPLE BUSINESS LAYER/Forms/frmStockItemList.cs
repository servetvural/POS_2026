...
namespace DTRMNS {
    public partial class frmStockItemList : Form {
        ...
        private void Tsi_Click(object sender, EventArgs e) {
            if (dgv.SelectedRows.Count > 0) {
                ...
                for (int i = 0; i < dgv.SelectedRows.Count; i++) {
                    StockItem si = bslayer.GetStockItem(dgv.SelectedRows[i].Cells[0].Value.ToString());
        ...
        private void btnEdit_Click(object sender, EventArgs e) {
            if (dgv.SelectedRows.Count > 0) {
                StockItem stockItem = bslayer.GetStockItem(dgv.SelectedRows[0].Cells[0].Value.ToString());
        ...
        private void btnSelect_Click(object sender, EventArgs e) {
            if (dgv.SelectedRows.Count > 0) {
                selectedStockItem = bslayer.GetStockItem(dgv.SelectedRows[0].Cells[0].Value.ToString());
        ...
        private void QuantityType_Click(object sender, EventArgs e) {
            if (dgv.SelectedRows.Count > 0) {
        ...
        {
            List<StockItem> itemList = bslayer.GetAllStockItemsList();
