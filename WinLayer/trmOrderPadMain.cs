...
namespace WinLayer
{
    ...
    public class trmOrderPadMain : System.Windows.Forms.Form
    {
        ...
        private System.Windows.Forms.Timer tmrHoldingOrders;
        ...
        private System.Windows.Forms.Timer tmrScreenSaverTrigger;
        ...
        private System.Windows.Forms.Timer tmrHoldOrderAutoClose;
        ...
        private async Task LoadViewBars()
        {
            ...
            {
                ToolStripMenuItem btn = new ToolStripMenuItem();
                btn.Image = global::WinLayer.Properties.Resources.chef64;
                btn.Tag = distro;
        ...
        private async Task LoadBonusSchemes()
        {
            ...
            {
                ToolStripMenuItem btn = new ToolStripMenuItem();
                btn.Image = global::WinLayer.Properties.Resources.Bonus48;
        ...
        private async Task Lock()
        {
            if (blnLockable)
            {
                this.Hide();
                this.Enabled = false;
                await DetachPanel();  //To prevent any admin panel visibility
                Locker.Show();
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            tmrHoldingOrders = new System.Windows.Forms.Timer(components);
            pnlHolder = new Panel();
            tmrScreenSaverTrigger = new System.Windows.Forms.Timer(components);
            tmrHoldOrderAutoClose = new System.Windows.Forms.Timer(components);
            button7 = new Button();
            button9 = new Button();
            button8 = new Button();
            button10 = new Button();
            ...
            pnlStandardDisplay.Size = new Size(315, 898);
            ...
            OrderScreen.Size = new Size(315, 613);
            ...
            btnHoldAndReceipt.Location = new Point(220, 3);
            ...
            btnHoldOrder.Location = new Point(112, 3);
            ...
            pnlBonus.ProgressBarWidth = 216;
            pnlBonus.Size = new Size(315, 25);
            ...
            pnlSubTotal.Size = new Size(315, 898);
            ...
            pnlSubMoneyActions.Size = new Size(315, 713);
            ...
            button1.Location = new Point(222, 461);
            ...
            btnSubTotalCash.Location = new Point(111, 552);
            btnSubTotalCash.Margin = new Padding(6);
            btnSubTotalCash.Name = "btnSubTotalCash";
            btnSubTotalCash.Size = new Size(93, 155);
            ...
            btnSubTotalCashWR.Location = new Point(216, 552);
            btnSubTotalCashWR.Margin = new Padding(6);
            btnSubTotalCashWR.Name = "btnSubTotalCashWR";
            btnSubTotalCashWR.Size = new Size(93, 155);
            ...
            btnHideSubTotal.Size = new Size(93, 155);
            ...
            button58.Location = new Point(117, 6);
            button58.Margin = new Padding(12, 6, 12, 6);
            button58.Name = "button58";
            button58.Size = new Size(81, 79);
            ...
            button12.Location = new Point(222, 370);
            button12.Margin = new Padding(12, 6, 12, 6);
            button12.Name = "button12";
            button12.Size = new Size(81, 79);
            ...
            button6.Location = new Point(117, 461);
            button6.Margin = new Padding(12, 6, 12, 6);
            button6.Name = "button6";
            button6.Size = new Size(81, 79);
            ...
            button5.Location = new Point(117, 370);
            button5.Margin = new Padding(12, 6, 12, 6);
            button5.Name = "button5";
            button5.Size = new Size(81, 79);
            ...
            button57.Location = new Point(222, 6);
            button57.Margin = new Padding(12, 6, 12, 6);
            button57.Name = "button57";
            button57.Size = new Size(81, 79);
            ...
            button86.Location = new Point(117, 97);
            button86.Margin = new Padding(12, 6, 12, 6);
            button86.Name = "button86";
            button86.Size = new Size(81, 79);
            ...
            button75.Location = new Point(222, 97);
            button75.Margin = new Padding(12, 6, 12, 6);
            button75.Name = "button75";
            button75.Size = new Size(81, 79);
            ...
            button94.Location = new Point(117, 188);
            button94.Margin = new Padding(12, 6, 12, 6);
            button94.Name = "button94";
            button94.Size = new Size(81, 79);
            ...
            button93.Location = new Point(222, 188);
            button93.Margin = new Padding(12, 6, 12, 6);
            button93.Name = "button93";
            button93.Size = new Size(81, 79);
            ...
            btnC.Location = new Point(117, 279);
            btnC.Margin = new Padding(12, 6, 12, 6);
            btnC.Name = "btnC";
            btnC.Size = new Size(81, 79);
            btnC.TabIndex = 127;
            btnC.Text = "CLEAR";
            ...
            // mnuAdmin
            // 
            mnuAdmin.DropDownItems.AddRange(new ToolStripItem[] { mnuDebug, mnuReprintReport, mnuSupervisorReport, mnuChangeMenu, mnuReloadMenu, mnuOptions, mnuPrintAsInvoice, mnuPad, mnuDrawerCalculator });
            ...
            pnlOrderPad.Size = new Size(699, 0);
            ...
            pnlPendingOrders.Size = new Size(699, 69);
            ...
            } else
            {
                ...
                if (!BSLayer.Instance.ActiveMenu.categories.IsNullOrEmpty())
                {
                    ...
                    foreach (Category category in BSLayer.Instance.ActiveMenu.categories)
                    {
                        ...
                        btn.BackColor = Color.FromArgb(upe.category.BgColour);
                        btn.ForeColor = Color.FromArgb(upe.category.FgColour);

                        btn.TextAlign = (ContentAlignment)upe.category.TextAlign;
                        btn.ImageAlign = (ContentAlignment)upe.category.ImageAlign;
                        btn.TextImageRelation = (TextImageRelation)upe.category.TextImageRelation;

                        switch (category.ButtonDisplayStyle)
                        {
                        ...
                        try
                        {
                            btn.Font = new Font(upe.category.FFamily, (float)upe.category.FSize, (FontStyle)Enum.Parse(typeof(FontStyle), upe.category.FStyle));
                        } catch
                        {
                        ...
                        btn.Size = new Size(upe.category.Width, upe.category.Height);
        ...
        private async Task DisplayWorkArea(bool blnShow)
        {
            if (blnShow)
            {
                if (!blnPadOpenning)
        ...
        public async Task LoadAttachedOrder()
        {
        ...
        public async Task UnloadOrder()
        {
            ...
            switch (config.Auto_Order_Type)
            {
                case OrderTypes.Sitin:
                    ctlTables tpanel = ActivatorUtilities.CreateInstance<ctlTables>(ServiceHelper.Services, new GenericFunctionCallAsync(DetachPanel),
                        new GenericEventHandlerAsync(btnTableButton_Click), new GenericEventHandlerAsync(btnDirectTable_Click));
                    AttachPanel(tpanel);
                    break;
                //case OrderTypes.Pad:
        ...
        public async Task<bool> ShowCustomerDialog(bool blnEnsureContinuation, int NumberOfCopy, bool blnArchive, bool blnPrintLocal, bool blnEnforceDeliveryArchive)
        {
            if (blnEnsureContinuation)
                AttachPanel(ActivatorUtilities.CreateInstance<ctlCustomer>(ServiceHelper.Services, new GenericFunctionCallAsync(DetachCustomerPanel),
                    new RemoteCompleteAttachedOrderAsync(CompleteAttachedOrder), NumberOfCopy, blnArchive, blnPrintLocal, blnEnforceDeliveryArchive));
            else
                AttachPanel(ActivatorUtilities.CreateInstance<ctlCustomer>(ServiceHelper.Services, new GenericFunctionCallAsync(DetachCustomerPanel), null, NumberOfCopy, blnArchive, blnPrintLocal, blnEnforceDeliveryArchive));
            return false;
        }
        public async Task DetachCustomerPanel()
        {
            await DetachPanel();
            await OrderScreen.Display();
        }
        ...
        public async Task<bool> CompleteAttachedOrder(int NumberOfCopy, bool blnArchive, bool blnPrintLocal, bool blnEnforceDeliveryArchive)
        {
            string OrderIID = "";
            ...
            if (BSLayer.Instance.AttachedOrder != null)
            {
                ...
                {
                    if (!ShowCustomerDialog(true, NumberOfCopy, blnArchive, blnPrintLocal, blnEnforceDeliveryArchive).Result)
                        return false;
                }
                    ...
                    if (BSLayer.Instance.AttachedOrder.Payment == PaymentMethods.NotPaid)
                    {
                        switch (BSLayer.Instance.AttachedOrder.OrderType)
                        {
                            case OrderTypes.Sale:
                                ...
                                {
                                    AttachPanel(ActivatorUtilities.CreateInstance<ctlPayment>(ServiceHelper.Services, new GenericFunctionCallAsync(DetachPanel),
                                        new RemoteCompleteAttachedOrderAsync(CompleteAttachedOrder), NumberOfCopy, blnArchive,
        ...
        private async Task PrintFinalPayment(PaymentMethods paymentMethod, bool withReceipt)
        {
            ...
            if (BSLayer.Instance.AttachedOrder != null)
            {
                ...
                switch (BSLayer.Instance.AttachedOrder.OrderType)
                {
                    case OrderTypes.Sale:
                        if (withReceipt)
                            await CompleteAttachedOrder(config.Direct_Sale_Receipt_Count, true, true, false);
                        else
                            await CompleteAttachedOrder(0, true, false, false);
                        break;
                    case OrderTypes.Sitin:
                        if (withReceipt)
                            await CompleteAttachedOrder(config.Table_Orders_Receipt_Count, true, true, false);
                        else
                            await CompleteAttachedOrder(0, true, false, false);
                    ...
                    case OrderTypes.TakeAway:
                        ...
                        if (withReceipt)
                            await CompleteAttachedOrder(config.TakeAway_Orders_Receipt_Count, true, true, false);
                        else
                            await CompleteAttachedOrder(config.TakeAway_Orders_Receipt_Count, true, true, false);
                        break;
                    case OrderTypes.Delivery:
                        ...
                        if (withReceipt)
                            await CompleteAttachedOrder(config.Delivery_Orders_Receipt_Count, true, true, false);
                        else
                            await CompleteAttachedOrder(config.Delivery_Orders_Receipt_Count, true, true, false);
                        break;
                    default:
        ...
        private async void cmdTables_Click(object sender, EventArgs e)
        {
            ...
            if (await SafelyPackTheOrder(StatusFlags.Done, true))
            {
                ctlTables tpanel = new ctlTables(new GenericFunctionCallAsync(DetachPanel),
                    new GenericEventHandlerAsync(btnTableButton_Click), new GenericEventHandlerAsync(btnDirectTable_Click));
                AttachPanel(tpanel);
            }
        }
        ...
        private async void cmdOrders_Click(object sender, EventArgs e)
        {
            if (config.Order_Reloads_Allowed || (BSLayer.Instance.LoggedUser.AccessLevel != AccessLevels.User))
            {
                ...
                ctlOrders fo = ActivatorUtilities.CreateInstance<ctlOrders>(ServiceHelper.Services, new GenericFunctionCallAsync(UnloadOrder),
                    new GenericFunctionCallAsync(LoadAttachedOrder),
                    new GenericFunctionCallAsync(DetachPanel),
                    new PassControl(AttachPanel),
                    new RemoteCompleteAttachedOrderAsync(CompleteAttachedOrder));
        ...
        private async void cmdReports_Click(object sender, EventArgs e)
        {
            ...
            if (fsp.ShowDialog() == DialogResult.OK)
            {
                ...
                if (report.RequireCashDrawTotal)
                {
                    ...
                    TrmDrawerCount frmDrawer = ActivatorUtilities.CreateInstance<TrmDrawerCount>(ServiceHelper.Services);
        ...
        private async void cmdCustomer_Click(object sender, EventArgs e)
        {
            await ShowCustomerDialog(false, 0, false, false, false);
        }
        ...
        private async void cmdPad_Click(object sender, EventArgs e)
        {
            if (BSLayer.Instance.AttachedOrder == null)
            {
                ...
                {
                    ctlTables tpanel = ActivatorUtilities.CreateInstance<ctlTables>(ServiceHelper.Services, new GenericFunctionCallAsync(DetachPanel), new GenericEventHandlerAsync(btnTableButton_Click), new GenericEventHandlerAsync(btnDirectTable_Click));
                    AttachPanel(tpanel);
                    return;
                } else
                {
                    ...
                    blnPadOpenning = true;
                    await LoadAttachedOrder();
                    AttachPanel(ActivatorUtilities.CreateInstance<ctlNumberPad>(ServiceHelper.Services, new GenericFunctionCallAsync(DetachPanel)));
        ...
        {
            TrmDrawerCount frm = new TrmDrawerCount(true);
            frm.ShowDialog();
        }
        ...
        private async void btnPrintCashFinalPaymentNoReceipt_Click(object sender, System.EventArgs e)
        {
            ...
            await PrintFinalPayment(PaymentMethods.Cash, false);
        }
        private async void btnPrintCashFinalPaymentWithReceipt_Click(object sender, System.EventArgs e)
        {
            ...
            await PrintFinalPayment(PaymentMethods.Cash, true);
        }
        private async void btnPrintCardFinalPaymentNoReceipt_Click(object sender, System.EventArgs e)
        {
            frmConfirmCardPayment frm = new frmConfirmCardPayment();
            if (frm.ShowDialog() == DialogResult.OK)
            {
                await PrintFinalPayment(PaymentMethods.Card, false);
            }
        }

        private async void btnPrintCardFinalPaymentWithReceipt_Click(object sender, System.EventArgs e)
        {
            frmConfirmCardPayment frm = new frmConfirmCardPayment();
            if (frm.ShowDialog() == DialogResult.OK)
            {
                await PrintFinalPayment(PaymentMethods.Card, true);
            }
        }

        private async void btnPrintOnlineFinalPaymentNoReceipt_Click(object sender, System.EventArgs e)
        {
            frmConfirmOnlinePayment frm = new frmConfirmOnlinePayment();
            if (frm.ShowDialog() == DialogResult.OK)
            {
                await PrintFinalPayment(PaymentMethods.Online, false);
            }
        }
        private async void btnPrintOnlineFinalPaymentWithReceipt_Click(object sender, System.EventArgs e)
        {
            frmConfirmOnlinePayment frm = new frmConfirmOnlinePayment();
            if (frm.ShowDialog() == DialogResult.OK)
            {
                await PrintFinalPayment(PaymentMethods.Online, true);
            }
        }
        ...
        private async Task OrderScreen_SplitEnding()
        {
            await UnloadOrder();
        }
        ...
        private async void LoadPendingOrders()
        {
            ...
            foreach (var order in pendingOrders)
            {
                ...
                } catch (Exception ex)
                {
                    ...
                    await repoDebug.Save(new Debug() { Data = "LoadingPendingOrders " + ex.Message });
                }
            ...
            if (config.Screen_Lock_Method != ScreenLockTypes.None)
            {
                ...
                if (config.Screen_Lock_Method == ScreenLockTypes.ScreenSaverLock)
                {
                    ...
                    if (screenLockCounter >= config.Seconds_Before_ScreenLock)
                    {
                        ...
                        tmrScreenSaverTrigger.Enabled = false;
                        screenLockCounter = 0;
                        frmScreenSaver frm = ActivatorUtilities.CreateInstance<frmScreenSaver>(ServiceHelper.Services);
                        frm.ShowDialog();
        ...
        private void btnSupplierPurchaseList_Click(object sender, EventArgs e)
        {
            ...
            //            item.Image = global::WinLayer.Properties.Resources.trolly48;
            //        else
            //            item.Image = null; // global::WinLayer.Properties.Resources.happy2_48;
            //    }
        ...
        private async Task LoadSupplierList()
        {
            ...
            foreach (var supp in suppliers)
            {
                ...
                btn.Tag = supp.IID;
                //btn.Image = global::WinLayer.Properties.Resources.trolly48;
        ...
        {
            frmStockUsagePad frm = ActivatorUtilities.CreateInstance<frmStockUsagePad>(ServiceHelper.Services);
        ...
        private async void pnlBonus_Click(object sender, EventArgs e)
        {
            await pnlBonus.UpdateBonusDisplay();
        }
